    ...
    <Nav>
      <div className="nav-left">
        <Typography href="/" component="a" variant="h6" color="inherit" noWrap className="brand">
          ...
          {<img className="logo" src="/static/images/logo.png" alt="hashnews" height="32" />}
        </Typography>
        {
        ...
        {/*<Typography href={['https://async.art/gallery', 'https://opensea.io/assets', 'https://superrare.co/market', 'https://www.cryptovoxels.com/play'].randomElement()} component="a" variant="h6" color="inherit" noWrap className="brand">
            NFT 
        </Typography>*/}
        <Typography href="https://nft.k1ic.com/" component="a" variant="h6" color="inherit" className="text">
            NFT
        </Typography>
        <Typography href="https://ipfs.k1ic.com/" component="a" variant="h6" color="inherit" className="text">
            IPFS 
        </Typography>
        <Typography href="https://cryptoart.io/data" component="a" variant="h6" color="inherit" className="text">
            CryptoArt 
        </Typography>
        <Typography href="https://dappradar.com/nft-marketplaces" component="a" variant="h6" color="inherit" className="text">
            DappRadar 
        </Typography>
        {/*<Typography href="/badge_stat/?devcon_did=z1oSWa9YFJNUXTk93RyCSc4JGJBiVfNXfdD" component="a" variant="h6" color="inherit" noWrap className="brand">
            徽章
        </Typography>*/}
